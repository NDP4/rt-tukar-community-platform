...
--
-- Name: item_stats; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: rts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: user_request_stats; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: likes likes_item_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: members members_profile_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rts rts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_comments_item_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_likes_item_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_requests_item_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: rts update_rts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: items items_donor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: items items_rt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: likes likes_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: members members_rt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: requests requests_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: items Donors and RT admins can delete items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: items Donors and RT admins can update items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests Requesters, donors, and RT admins can update requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: comments Users can create comments on items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: items Users can create items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests Users can create requests for items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: comments Users can delete own comments or RT admins can delete any; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: members Users can join an RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: comments Users can view comments on items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: items Users can view items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests Users can view requests for items in their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts Users can view their RT; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes allow_all_select_likes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes allow_own_delete_likes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes allow_own_insert_likes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: comments comments_insert_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: comments comments_view_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: items items_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes likes_all_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes likes_insert_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes likes_view_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: members members_own_data; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: members members_own_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: members members_own_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: members members_own_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_own_data; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_own_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_own_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests requests_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests requests_insert_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests requests_update_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: requests requests_view_rt; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.rts ENABLE ROW LEVEL SECURITY;

--
-- Name: rts rts_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts rts_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts rts_read_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts rts_read_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rts rts_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects Anyone can view item photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Anyone can view item photos" ON storage.objects FOR SELECT USING ((bucket_id = 'items'::text));


--
-- Name: objects Authenticated users can upload item photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can upload item photos" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'items'::text) AND (auth.role() = 'authenticated'::text)));
...
CREATE POLICY "Users can delete own photos" ON storage.objects FOR DELETE USING (((bucket_id = 'items'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Users can delete their item photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can delete their item photos" ON storage.objects FOR DELETE USING (((bucket_id = 'items'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
CREATE POLICY "Users can update own photos" ON storage.objects FOR UPDATE USING (((bucket_id = 'items'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Users can update their item photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can update their item photos" ON storage.objects FOR UPDATE USING (((bucket_id = 'items'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));


--
-- Name: objects Users can upload item photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can upload item photos" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'items'::text) AND ((auth.uid())::text = (storage.foldername(name))[1])));
...
--
-- Name: objects item-images-delete; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "item-images-delete" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'item-images'::text));


--
-- Name: objects item-images-select; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "item-images-select" ON storage.objects FOR SELECT USING ((bucket_id = 'item-images'::text));


--
-- Name: objects item-images-upload; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "item-images-upload" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'item-images'::text));
...
--
-- Name: TABLE item_stats; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE rts; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE user_request_stats; Type: ACL; Schema: public; Owner: -
--
