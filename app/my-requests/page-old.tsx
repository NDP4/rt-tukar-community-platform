      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage requests for your items</p>
          </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <textarea
                          ...
                          className="w-full min-h-20 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        />
